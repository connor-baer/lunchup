...
function initSlack(SLACK_BOT_TOKEN, SLACK_API_TOKEN) {
  ...
  rtm.on(RTM_EVENTS.MESSAGE, message => {
    ...
    function contains(words) {
      return words.some(word => includes(content, word));
    }
    ...
    winston.info(`Message received: ${JSON.stringify(message)}`);
    ...
    switch (true) {
      ...
      case contains(['hello', 'hi', 'ciao', 'hallo']):
        ...
        break;
      default:
        rtm.sendMessage(`I'm sorry <@${user}>, I can't understand your message.`, channel);
    }
  });
